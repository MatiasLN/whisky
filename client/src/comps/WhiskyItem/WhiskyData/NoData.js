...
let ProductDetails = ({
  ...
  const [percentageState, setPercentage] = useState("");
  const [priceState, setPrice] = useState("");
  const [countryState, setCountry] = useState("");
  const [regionState, setRegion] = useState("");
  const [destileryState, setDestilery] = useState("");
  const [tasteState, setDescTaste] = useState("");
  const [odourState, setDescOdour] = useState("");
  const [colourState, setDescColour] = useState("");
